...
public class PlayerBoardV1_19_R2 extends BPlayerBoard {
	private EntityPlayer playerHandle;
	private Field playerScoreField;

	public PlayerBoardV1_19_R2(INetheriteBoard netheriteBoard, Player player, String name) throws Exception {
		this(netheriteBoard, player, null, name);
	}

	public PlayerBoardV1_19_R2(INetheriteBoard netheriteBoard, Player player, Scoreboard scoreboard, String name) throws Exception {
