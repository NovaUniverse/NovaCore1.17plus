...
public class PlayerBoardV1_18_R1 extends BPlayerBoard {
	private EntityPlayer playerHandle;
	private Field playerScoreField;

	public PlayerBoardV1_18_R1(INetheriteBoard netheriteBoard, Player player, String name) throws Exception {
		this(netheriteBoard, player, null, name);
	}

	public PlayerBoardV1_18_R1(INetheriteBoard netheriteBoard, Player player, Scoreboard scoreboard, String name) throws Exception {
